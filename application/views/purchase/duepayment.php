      ...
      <div class="row">
        <div class="col-md-12">
         ...
         <div class="box box-info">
            ...
            <!-- form start -->
            <?php echo form_open('purchase/paydues',array('class'=>'form-horizontal')); ?>
              <div class="box-body">
                <div class="form-group">
                  <label for="Customer Name" class="col-sm-2 control-label">Supplier Name</label>
                  <div class="col-sm-6">
                    <?php 
						$data = array('name' => 'supplier_name', 'id'=> 'supplier_name', 'placeholder'=>'Supplier Name', 'class'=>'form-control','value'=>$selinvoice['supplier_name'],'readonly'=>'readonly');
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <?php 
						$data = array('name' => 'invoice_no', 'id'=> 'invoice_no', 'placeholder'=>'Invoice No.', 'class'=>'form-control','value'=>$selinvoice['invoice_no'],'readonly'=>'readonly');
						echo form_input($data);
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-6">
                   <?php 
						$data = array('name' => 'paid', 'id'=> 'paid', 'placeholder'=>'Paid', 'class'=>'form-control','value'=>$selinvoice['paid'],'readonly'=>'readonly');
						echo form_input($data);
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                   <?php 
						$data = array('name' => 'dues', 'id'=> 'dues', 'placeholder'=>'Paid', 'class'=>'form-control','value'=>$selinvoice['total']-$selinvoice['paid'],'readonly'=>'readonly');
						echo form_input($data);
                ...
                <input type="hidden" name="supp_id" value="<?php echo $selinvoice['supp_id'] ?>" />
				...
				?>
                &nbsp;&nbsp;<a href="<?php echo base_url('purchase/invoicelist'); ?>" class="btn btn-danger">Close</a>
              </div>
              </div>
              <!-- /.box-body -->
            <?php echo form_close(); ?>
