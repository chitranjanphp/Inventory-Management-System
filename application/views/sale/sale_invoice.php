    ...
    <section class="content">
      <div class="row">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?php echo base_url('sale/add_sale'); ?>" method="post">
              <div class="box-body">
            	...
            	<div id="temp_input_field">
                	<table style="margin-left:20px">
                    	<tbody><tr>
                            ...
                            <th width="1%"></th>
                        	<th width="10%" style="text-align:center">Available Qty</th>
                            <th width="1%"></th>
                    	...
                    	<tr>
                            ...
                            <td></td>
                        	<td>
                            	<input type="text" name="availqty" id="availqty" class="form-control" placeholder="Available Qty" autocomplete="off" readonly="readonly">
                            </td>
                            <td></td>
                        	<td>
                            ...
                            <td></td>
                        	<td>
                            	<input type="text" name="qty" id="qty" class="form-control" placeholder="Qty" autocomplete="off">
                            </td>
                            <td></td>
                            <td>
