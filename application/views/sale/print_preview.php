        ...
        <div id="invoice" style="width:1000px;">
                ...
                <div class="row no-print">
                    <div class="col-xs-12 text-center">
                      <a href="<?php echo base_url('sale/print_invoice/'.$invoice['invoice_id']); ?>" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print</a>
                      <a href="<?php echo base_url('sale/'); ?>" class="btn btn-danger"><i class="fa fa-times"></i> Cancel</a>
                    </div>
                 </div>
            </div>
      </div>
