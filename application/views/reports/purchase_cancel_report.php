          ...
          <div class="box list">
            ...
            <div class="box-body table-responsive" id="result">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php
					if(is_array($purchasecancel)){
						foreach($purchasecancel as $row){
				?>
				<tr>
...
<script>
  ...
  /********search***************/	
	function SearchList(){
		...
		$.ajax({
			type:'POST',
			url:url+'reports/search_purchase_cancel/',
	...
	function searchfields(from,to){
		...
		$('#example1_length').parent().removeAttr("class").addClass("col-md-4 col-sm-8");
