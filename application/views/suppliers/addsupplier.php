      ...
      <div class="row">
        <div class="col-md-12">
         ...
         <div class="box box-info">
            ...
            <!-- form start -->
            <?php echo form_open('suppliers/addsupplier',array('class'=>'form-horizontal')); ?>
              <div class="box-body">
                <div class="form-group">
                  <label for="Supplier Name" class="col-sm-2 control-label">Supplier Name</label>
                  <div class="col-sm-6">
                    <?php 
						$data = array('name' => 'supplier_name', 'id'=> 'supplier_name', 'placeholder'=>'Supplier Name', 'class'=>'form-control','value'=>set_value('supplier_name'));
                ...
                <?php 
					$data = array('name' => 'addsupplier', 'value'=>'Submit', 'class'=>'btn btn-info pull-left');
